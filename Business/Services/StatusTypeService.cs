...
public class StatusTypeService(IStatusTypeRepository statusTypeRepository) : IStatusTypeService
{
    ...
    {
        var entity = await _statusTypeRepository.GetStatusTypeEntityAsync(x => x.StatusName == form.StatusName);
        entity ??= await _statusTypeRepository.CreateStatusTypeEntityAsync(StatusTypeFactory.Create(form));
        return StatusTypeFactory.Create(entity);
    }

    public async Task<IEnumerable<StatusType>> GetAllStatusTypesAsync()
    {
        var entities = await _statusTypeRepository.GetAllStatusTypeEntityAsync();
    ...
    {
        var entity = await _statusTypeRepository.GetStatusTypeEntityAsync(expression);
    ...
    {
        var entity = await _statusTypeRepository.UpdateStatusTypeEntityAsync(StatusTypeFactory.Create(form));
        var product = StatusTypeFactory.Create(entity);
        return product ?? null!;
    }
    ...
    {
        var result = await _statusTypeRepository.DeleteStatusTypeEntityAsync(x => x.Id == id);
        return result;
    }
}
